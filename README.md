...
> > 2. 2. Set up Node.js 22
> >    3. 3. Install backend dependencies (`src/backend`)
> >       4. 4. Install frontend dependencies (`src/frontend`)
> >          5. 5. Build the React app (`src/frontend/build/`)
> >             6. 6. Deploy the full repository to Azure Web App
> >               
> >                7. **Required GitHub Secrets:**
> >               
> >                8. | Secret | Description |
> >                9. |-------------------------------|--------------------------------------|
> >                10. | `AZURE_WEBAPP_NAME` | Name of the Azure App Service |
